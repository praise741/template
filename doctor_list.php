...
<!-- Mirrored from doccure-html.dreamguystech.com/template/admin/doctor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 19:05:44 GMT -->
<head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
        <title>Doccure - Doctors List</title>
    ...
    <body>
        ...
        $sql = 'SELECT * FROM doctor WHERE verification="" ';
		...
		?>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a  class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="passport/<?php echo $row["passport"]; ?>"></a>
															<a><?php echo $row["fullname"]; ?></a>
														</h2>
													</td>
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" <?php echo "href='verify.php?email=".$row['email']."'";?>>VERIFY</a>
                                            <div class="dropdown-divider"></div>
											<a class="dropdown-item" onClick="return confirm('Are you sure you want to delete this file?');" <?php echo "href= 'delete.php?email=".$row['email']."'";?>>DELETE</a>
										</div>
									</div></td>
		...
		<!-- Datatables JS -->
		<script src="assets(2)/plugins/datatables/jquery.dataTables.min.js"></script>
		<script src="assets(2)/plugins/datatables/datatables.min.js"></script>
