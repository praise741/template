...
?> 
    ...
    <div class="appointment-action">
        <a href="patient/register_patient.php" onClick="return confirm('you have to login before you can proceed to booking our doctors do you want to proceed?');" class="btn btn-sm bg-info-light" >
