...
<!-- Mirrored from doccure-html.dreamguystech.com/template/dependent.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 19:03:55 GMT -->
<head>
	<meta charset="utf-8">
	<title>Doccure</title>
		...
		<header class="header">
			<nav class="navbar navbar-expand-lg header-nav">
				...
				<div class="main-menu-wrapper">
					...
					<ul class="main-nav">
						<li class="has-submenu">	<a href="#">Home <i class="fas fa-chevron-down"></i></a>
							<ul class="submenu">
						...
						<li class="has-submenu active">	<a href="#">Patients <i class="fas fa-chevron-down"></i></a>
							<ul class="submenu">
								<li class="has-submenu">	<a href="#">Doctors</a>
									<ul class="submenu">
										<li><a href="map-grid.html">Map Grid</a>
										</li>
										<li><a href="map-list.html">Map List</a>
										</li>
									</ul>
								</li>
								<li><a href="search.html">Search Doctor</a>
								</li>
								<li><a href="doctor-profile.html">Doctor Profile</a>
								</li>
								<li><a href="booking.html">Booking</a>
								</li>
								<li><a href="checkout.html">Checkout</a>
								</li>
								<li><a href="booking-success.html">Booking Success</a>
								</li>
								<li class="active"><a href="patient-dashboard.html">Patient Dashboard</a>
								</li>
								<li><a href="favourites.html">Favourites</a>
								</li>
						...
						<li class="has-submenu">	<a href="#">Pages <i class="fas fa-chevron-down"></i></a>
							<ul class="submenu">
								...
								<li><a href="search.html">Search Doctors</a>
								</li>
								...
								<li class="has-submenu">	<a href="invoices.html">Invoices</a>
									<ul class="submenu">
										...
										<li><a href="invoice-view.html">Invoice View</a>
										</li>
									</ul>
								</li>
								<li><a href="blank-page.html">Starter Page</a>
								</li>
						...
						<li>	<a href="admin/index.html" target="_blank">Admin</a>
						</li>
				...
				<ul class="nav header-navbar-rht">
					...
					<li class="nav-item dropdown has-arrow logged-item">
						...
						<div class="dropdown-menu dropdown-menu-right">
							...
							</div>	<a class="dropdown-item" href="patient-dashboard.html">Dashboard</a>
			...
			<div class="container-fluid">
				<div class="row">
						...
						<div class="profile-sidebar">
							...
							<div class="dashboard-widget">
								<nav class="dashboard-menu">
									<ul>
										<li>
											<a href="patient-dashboard.html">	<i class="fas fa-columns"></i>
												<span>Dashboard</span>
											</a>
										</li>
										<li>
											<a href="favourites.html">	<i class="fas fa-bookmark"></i>
												<span>Favourites</span>
											</a>
										</li>
										<li class="active">
											<a href="dependent.html">	<i class="fas fa-users"></i>
												<span>Dependent</span>
											</a>
										</li>
										<li>
											<a href="chat.html">	<i class="fas fa-comments"></i>
												<span>Message</span>
												<small class="unread-msg">23</small>
											</a>
										</li>
										<li>
											<a href="profile-settings.html">	<i class="fas fa-user-cog"></i>
												<span>Profile Settings</span>
											</a>
										</li>
										<li>
											<a href="change-password.html">	<i class="fas fa-lock"></i>
												<span>Change Password</span>
											</a>
										</li>
										<li>
											<a href="index.html">	<i class="fas fa-sign-out-alt"></i>
												<span>Logout</span>
											</a>
										</li>
									</ul>
					...
					<div class="col-md-7 col-lg-8 col-xl-9">
						<div class="card">
							<div class="card-body ">	<a href="add-dependent.html" class="btn book-btn add-btn" tabindex="0">Add Dependent</a>
								<!-- Dependent Tab -->
								<div class="mt-4">
...
<!-- Mirrored from doccure-html.dreamguystech.com/template/dependent.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 19:03:56 GMT -->
</html>