...
<!-- Mirrored from doccure-html.dreamguystech.com/template/doctor-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:53:06 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form action="https://doccure-html.dreamguystech.com/template/doctor-dashboard.html">
                                            ...
                                            <div class="form-group form-focus">
                                                <input type="text" class="form-control floating" name="quallififcations" placeholder="please input your type of certificate" id="">
                                                <label class="focus-label">Input type of quallififcations</label>
                                        </div>
