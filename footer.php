						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="footer-widget footer-about">
								...
								<div class="footer-about-content">
									<p>We are committed to givving our best to our patients use the best skill and technology we have just to make you more healthy and happier.</p>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="footer-widget footer-menu">
								...
								<ul>
									...
									<li><a href="patient/login_p.php">Login</a>
									</li>
									<li><a href="patient/register_patient.php">Register</a>
									</li>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="footer-widget footer-menu">
								...
								<ul>
									...
									<li><a href="login_r.php">Login</a>
									</li>
									<li><a href="register_doctor.php">Register</a>
									</li>
						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
								<div class="copyright-text">
									<p class="mb-0">&copy; <?php include("copyright.inc.php") ?> Doccure. All rights reserved.</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<!-- Copyright Menu -->
